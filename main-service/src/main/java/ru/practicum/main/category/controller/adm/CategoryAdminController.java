package ru.practicum.main.category.controller.adm;
...
public class CategoryAdminController {
    ...
    public ResponseEntity<CategoryDto> addCategoryAdmin(@RequestBody @Valid NewCategoryDto newCategoryDto) {
        log.info("Received POST request for add new category with body={}", newCategoryDto);
    ...
    public ResponseEntity<CategoryDto> updateCategoryAdmin(@RequestBody @Valid CategoryDto categoryDto,
        ...
        log.info("Received PATCH request for update category with id={}, requestBody={}", categoryId, categoryDto);
