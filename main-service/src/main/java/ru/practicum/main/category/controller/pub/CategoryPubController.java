package ru.practicum.main.category.controller.pub;
...
public class CategoryPubController {
    ...
    public ResponseEntity<Collection<CategoryDto>> getAllCategoriesPub(
        ...
        log.info("Received GET request for return categories from={}, size={}", from, size);
    ...
    public ResponseEntity<CategoryDto> getCategoryByIdPub(
        ...
        log.info("Received GET request for return category by categoryId={}", categoryId);
