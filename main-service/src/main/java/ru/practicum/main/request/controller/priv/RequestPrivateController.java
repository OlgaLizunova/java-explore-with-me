package ru.practicum.main.request.controller.priv;
...
public class RequestPrivateController {
    ...
    public ResponseEntity<ParticipationRequestDto> addRequest(
        ...
        log.info("Received POST request for add new ParticipationRequest for userId={}, eventId={}", userId, eventId);
    ...
    public ResponseEntity<List<ParticipationRequestDto>> getRequestsPrivate(
        ...
        log.info("Received GET request for get ParticipationRequests for userId={}",
                userId);
    ...
    public ResponseEntity<ParticipationRequestDto> cancelOwnRequest(
        ...
        log.info("Received PATCH request from userId={} for cancel ParticipationRequest requestId={}", userId, requestId);
