package ru.practicum.main.events.controller.pub;
...
import ru.practicum.main.exception.InvalidDateRangeException;
import ru.practicum.main.utils.EventSort;
...
public class EventPublicController {
    ...
    public ResponseEntity<Collection<EventShortDto>> findEventsPublic(
        ...
        log.info("Received GET to find events by " +
    ...
    public ResponseEntity<EventFullDto> getEventByIdPublic(
        ...
        log.info("Received GET to find events by id={}", id);
        log.info("HttpServletRequest: remoteAddr={}, requestURI={}", request.getRemoteAddr(), request.getRequestURI());
