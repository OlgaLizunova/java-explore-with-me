package ru.practicum.main.events.controller.priv;
...
public class EventsPrivateController {
    ...
    public ResponseEntity<EventFullDto> addEvent(
        ...
        log.info("Received POST request from userId={} for add new event with body={}", userId, newEventDto);
    ...
    public ResponseEntity<Collection<EventShortDto>> getAllUsersEvents(
        ...
        log.info("Received GET request for return All events with userId={}, from={}, size={}", userId, from, size);
    ...
    public ResponseEntity<EventFullDto> getUsersEventById(
        ...
        log.info("Received GET request for return event with eventId={}, for userId={}", eventId, userId);
    ...
    public ResponseEntity<EventFullDto> updateUsersEvent(
        ...
        log.info("Received PATCH private request for update event with eventId={}, for userId={}, with body={}",
    ...
    public ResponseEntity<Collection<ParticipationRequestDto>> getUserEventRequests(
        ...
        log.info("Received GET request for return requests for event with eventId={}, for userId={}", eventId, userId);
    ...
    public ResponseEntity<EventRequestStatusUpdateResult> updateEventRequestsStatus(
        ...
        log.info("Received PATCH private request from userId={} for update eventId={} with updateRequest={}",
