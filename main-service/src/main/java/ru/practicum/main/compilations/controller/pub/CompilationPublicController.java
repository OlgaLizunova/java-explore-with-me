package ru.practicum.main.compilations.controller.pub;
...
public class CompilationPublicController {
    ...
    public ResponseEntity<Collection<CompilationDto>> getAllCompilationsPub(
        ...
        log.info("Received GET request for return compilation from={}, size={}, pinned={}", from, size, pinned);
    ...
    public ResponseEntity<CompilationDto> getCompilationByIdPub(
        ...
        log.info("Received GET request for return compilation by compilationId={}", compId);
