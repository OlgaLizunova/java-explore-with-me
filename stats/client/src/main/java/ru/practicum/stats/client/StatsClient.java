...
public class StatsClient {
    ...
    public List<StatsDto> getViewStats(
        ...
        ResponseEntity<List<StatsDto>> result = getStats(parameters);
        ...
        List<StatsDto> stats = Collections.emptyList();
    ...
    private ResponseEntity<List<StatsDto>> getStats(Map<String, Object> parameters) {
        return client.get()
